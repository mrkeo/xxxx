...
const SocialLinks = () => (
  <>
    <a className="mr-3" href="https://github.com/trolit" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
      <svg 
          stroke="currentColor"
          fill="currentColor"
          strokeWidth="0"
    ...
    <a className="mr-3" href="https://dblp.org/pers/hd/i/Idzikowski:Pawel" target="_blank" rel="noopener noreferrer" aria-label="dblp">
      <svg 
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
    ...
    <a className="mr-3" href="https://profile-summary-for-github.com/user/trolit" target="_blank" rel="noopener noreferrer" aria-label="trolit account GitHub stats">
      <svg 
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
